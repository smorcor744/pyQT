...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_mostrar_clientes.setGeometry(QRect(500, 510, 121, 31))
        ...
        self.text_email_cliente.setGeometry(QRect(80, 560, 181, 31))
        ...
        self.bt_buscar_cliente = QPushButton(self.centralwidget)
        self.bt_buscar_cliente.setObjectName(u"bt_buscar_cliente")
        self.bt_buscar_cliente.setGeometry(QRect(830, 560, 75, 24))
        self.bt_buscar_cliente.setStyleSheet(u"background-color: rgb(0, 85, 255);")
        self.text_email_buscar = QLineEdit(self.centralwidget)
        self.text_email_buscar.setObjectName(u"text_email_buscar")
        self.text_email_buscar.setGeometry(QRect(770, 520, 181, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_mostrar_clientes.setText(QCoreApplication.translate("MainWindow", u"Mostrar clientes", None))
