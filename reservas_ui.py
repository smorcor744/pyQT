...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textFechaCheckin = QDateEdit(self.centralwidget)
        self.textFechaCheckin.setObjectName(u"textFechaCheckin")
        self.textFechaCheckin.setGeometry(QRect(70, 200, 241, 31))
        self.textFechaCheckin.setMaximumDateTime(QDateTime(QDate(2035, 12, 31), QTime(19, 59, 59)))
        self.textFechaCheckin.setMinimumDateTime(QDateTime(QDate(2025, 3, 14), QTime(21, 0, 0)))
        self.textFechaCheckout = QDateEdit(self.centralwidget)
        self.textFechaCheckout.setObjectName(u"textFechaCheckout")
        self.textFechaCheckout.setGeometry(QRect(70, 270, 241, 31))
        self.textFechaCheckout.setMaximumDateTime(QDateTime(QDate(2035, 12, 31), QTime(19, 59, 59)))
        self.textFechaCheckout.setMinimumDateTime(QDateTime(QDate(2025, 3, 14), QTime(21, 0, 0)))
