...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textTipo = QLineEdit(self.centralwidget)
        self.textTipo.setObjectName(u"textTipo")
        self.textTipo.setGeometry(QRect(50, 160, 241, 31))
        ...
        self.textDisponible.setGeometry(QRect(50, 300, 241, 31))
